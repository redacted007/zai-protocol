...
describe('State', function () {
  ...
  describe('erc20 details', function () {
    ...
    describe('symbol', function () {
      it('increments total bonded', async function () {
        expect(await this.setters.symbol()).to.be.equal('ZAIS')
      })
    })
  ...
  describe('incrementTotalRedeemable', function () {
    describe('when called', function () {
      ...
      it('increments total redeemable', async function () {
        expect(await this.setters.totalRedeemable()).to.be.bignumber.equal(
          new BN(200),
        )
      })
    })
  ...
  describe('unfreeze', function () {
    ...
    describe('when called', function () {
      ...
      it('is fluid', async function () {
        ...
        expect(
          await this.setters.fluidUntil(userAddress),
        ).to.be.bignumber.equal(new BN(240))
      })
    })
  ...
  describe('epochTime', function () {
    ...
    describe('after one period', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(BOOTSTRAPPING_END_TIMESTAMP + 1800)
      })
    ...
    describe('after many periods', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(
          BOOTSTRAPPING_END_TIMESTAMP + 10 * 1800,
        )
      })
    ...
    describe('one before update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(
          BOOTSTRAPPING_END_TIMESTAMP + 14 * 1800,
        )
      })
    ...
    describe('right before update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(
          BOOTSTRAPPING_END_TIMESTAMP + 15 * 1800 - 1,
        )
      })
    ...
    describe('at update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(
          BOOTSTRAPPING_END_TIMESTAMP + 15 * 1800,
        )
      })
    ...
    describe('at first after update advance', function () {
      beforeEach('call', async function () {
        await this.setters.setBlockTimestamp(
          BOOTSTRAPPING_END_TIMESTAMP + 15 * 1800 + 1800,
        )
      })
  ...
  describe('initializeCouponsExpiration', function () {
    describe('when called', function () {
      ...
      it('has expiration set', async function () {
        expect(await this.setters.couponsExpiration(2)).to.be.bignumber.equal(
          new BN(91),
        )
        expect(await this.setters.expiringCoupons(91)).to.be.bignumber.equal(
          new BN(1),
        )
        expect(
  ...
  describe('eliminateOutstandingCoupons', function () {
    ...
    describe('when called', function () {
      ...
      it('has expiration set', async function () {
        ...
        expect(await this.setters.outstandingCoupons(1)).to.be.bignumber.equal(
          new BN(0),
        )
        expect(
